...
class DatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        image_ir, image_ir_rgb, image_vi, visimage_bri, visimage_clr = utils.read_image(dataset_dict["file_name"],
        ...
        if self.proposal_topk is not None:
            utils.transform_proposals(
                dataset_dict, image_shape, None, proposal_topk=self.proposal_topk
            )
